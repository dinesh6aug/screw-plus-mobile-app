    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                <TouchableOpacity style={styles.addToCartButton} onPress={() => router.replace('/orders')}>
                    <Text style={styles.addToCartText}>View Orders</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buyNowButton} onPress={() => router.replace('/(tabs)')}>
